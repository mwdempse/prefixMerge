#custom Merge function which adds prefixes to merged columns instead of suffixes - modified from "base::merge.data.frame"
prefixMerge <- function (x, y, by = intersect(names(x), names(y)), by.x = by,
